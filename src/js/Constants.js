var Constants = {
    release : {
        ...
        announcements   : [
            ...
            '-----------',
            '一部Windows環境でログインできないという報告をいただいております',
            'これに対し、セキュリティソフトのWeb監視を止めたら治った場合や、Windowsのプロファイルを作り直したら治った場合などが報告されております',
            'いずれにしても『艦これウィジェット』が原因ではなく、サーバ上のユーザ情報には（当然ですけど）影響は無いと思われます',
            'たびたび申し上げますが『艦これウィジェット』は非公式ツールであり、利用は推奨されません',
            '提督各位が、安全に、ほどよく快適に、艦これが楽しめることだけを望んでいます'
        ]
    },
