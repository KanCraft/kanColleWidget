var Constants = {
    release : {
        version: "v1.5.25",
        link: 'https://github.com/otiai10/kanColleWidget/pull/550',
        announceVersion : 134,
        announcements   : [
          "「取得中...」窓をあえて出さないようにする設定を追加",
          "--------",
          "ひさしぶりの更新です。イベント進捗どうですか？",
          "ついでなので周知ですが、連合艦隊の第二艦隊の大破進撃防止窓が出るタイミングがちょっと難しいので注意です。",
          "第二艦隊の大破進撃防止窓は「第一艦隊の窓が出てから<u>2クリック目</u>のタイミング」でスクショを撮って表示してます。",
          "なので、連打癖のあるひとは、第一艦隊の窓がふたつ出現して意味不明だと思いますが、仕様です、ごめんなさい。おちついて「次」が右下に出たらクリックするようにしてください。",
          "なお、当方はE2を丙で攻略中です。"
        ]
    },
