var Constants = {
    release : {
        version: "v1.5.7",
        link: 'https://github.com/otiai10/kanColleWidget/pull/506',
        announceVersion : 111,
        announcements   : [
            '改修工廠任務を追加',
            '画像のデフォルトフォーマットをpngにします',
            '------------',
            'たいへんお待たせしました。改修工廠任務に対応しました。コミッター各位いつもありがとうございます！',
            '画像のデフォルトフォーマットがjpgになって画像がもやっていたので、この際デフォルトでpngにしました。今まで変更してないひとはjpgになってるので、pngに変えたほうが画質上がるかもしれません',
            '------------',
            'なお当方、E5丙にしてもなお間に合いませんでした...無念'
        ]
    },
